    ...
    return (
        <header className="h-16 bg-white border-b flex items-center justify-between px-6 shadow-sm sticky top-0 z-10">
            <div className="flex items-center gap-4">
                ...
                {/* Breadcrumb hoặc Title mặc định */}
            ...
            <div className="flex items-center gap-4">
                {/* Search Bar nhỏ trên header (optional) */}
                <div className="hidden md:flex items-center bg-gray-100 rounded-full px-3 py-1.5">
                    <Search size={16} className="text-gray-400" />
                    <input type="text" placeholder="Tìm kiếm nhanh..." className="bg-transparent border-none text-sm ml-2 focus:outline-none w-48" />
                </div>
